...
public final class OutrasCausasFragment_
    extends OutrasCausasFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.frag_outras_causas, container, false);
        }
        return contentView_;
    }
    ...
    public static OutrasCausasFragment_.FragmentBuilder_ builder() {
        return new OutrasCausasFragment_.FragmentBuilder_();
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        OutrasCausasFragment_.this.addMedication();
                    }
    ...
    public static class FragmentBuilder_ {
        ...
        public OutrasCausasFragment build() {
            OutrasCausasFragment_ fragment_ = new OutrasCausasFragment_();
